    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="login_signup.php" class="getstarted">Sign Up</a></li>
        </ul>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="authenticate.php" method="POST">
              ...
              <!-- reCAPTCHA widget -->
              <div class="g-recaptcha" data-sitekey="6LeOwPEpAAAAAJocRYkHLSMjtf0kb8SEvT0w1Cwv"></div>
                <div class="mb-3">
              </div>
              <p><a href="forgotpassword.php">Forgot Password?</a></p>
              <p><a href="login_signup.php">Create New Account</a></p>
              <div class="mb-3">
