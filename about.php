...
<head>
  ...
  <title>About - Discover Cebu</title>
...
<body>
  ...
  <main id="main">
    ...
    <div class="carousel-container text-center mt-5 ">
      <div class="container">
        <h1 class="animate__animated animate__fadeInDown display-3 text-uppercase fw-bold">About<spam style="color:#d9232d"> Cebu</spam>
        </h1>
      </div>
    </div>
